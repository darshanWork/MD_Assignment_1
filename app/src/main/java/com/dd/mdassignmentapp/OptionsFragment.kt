...
import com.dd.mdassignmentapp.databinding.FragmentMainBinding
...
class OptionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.earthButton.setOnClickListener{
            navController.navigate(R.id.action_optionsFragment_to_earthFragment)
        }
        binding.moonButton.setOnClickListener{
            navController.navigate(R.id.action_optionsFragment_to_moonFragment)
        }
    }
